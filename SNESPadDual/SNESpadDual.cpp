/*
  SNESpad - Arduino library for interfacing with two SNES joysticks

  Version: 1.4 (10/01/2012) - Modified for dual controllers (John Byers)
...
int SNESpad::buttons(void)
{
  ...
  unsigned long ret3 = (ret << 16 | ret2);
  return ~ret3;
}
